...
void main()
{
    ...
    Menu:
        ...
        printf("Chon chuc nang: "), scanf("%u", &menu);
        if (!(menu <= 11))
        {
    ...
    while (1)
    {
        ...
        CASE7:
            ...
            printf("\nNhap phan tram vay toi da: "), scanf("%lf", &LaiSuatChoVay);
        ...
        Game:
            ...
            {
                CHUC_NANG_9(A, B);
                printf("\nBan co muon choi lai khong? [Y/N]: "), fflush(stdin), gets(playAgain);
